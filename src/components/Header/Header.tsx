          ...
          <div className="flex items-center justify-between">
            ...
            <div className="lg:ml-auto lg:items-center lg:space-x-8 xl:space-x-10">
              <a
                ...
                title=""
                onClick={openModal}
                className="bg-prime rounded-xl border border-transparent px-5 py-2 font-pj text-base font-bold leading-7 text-white transition-all duration-200 hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
                role="button"
              >
                Request demo
              </a>
