...
const _Advantages = () => {
  return (
    <section className="mt-20 px-16 py-12 max-md:mt-10 max-md:max-w-full max-md:px-5">
      <div className="container mx-auto mb-32 mt-7 flex w-full flex-col items-stretch max-md:mb-10 max-md:max-w-full">
        ...
        <div className="mt-16 max-md:mt-10 max-md:max-w-full">
          <div className="flex flex-wrap justify-between gap-10 max-md:flex-col max-md:items-stretch max-md:gap-0 lg:gap-16">
