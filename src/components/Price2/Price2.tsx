    ...
    <section className="py-12 bg-white sm:py-16 lg:py-20">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
              ...
              <div className="md:flex md:items-center md:space-x-12 lg:space-x-24">
                ...
                <div className="block md:hidden lg:block">
                  <div className="hidden lg:block">
                    <svg className="w-4 h-auto text-gray-600" viewBox="0 0 16 123" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="block mt-10 md:hidden">
                    <svg className="w-auto h-4 text-gray-600" viewBox="0 0 172 16" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="mt-10 md:mt-0">
                  <div className="flex items-end">
                    ...
                    <p className="text-lg font-medium text-gray-400 font-pj">/month</p>
                  </div>
        ...
        <div className="max-w-2xl mx-auto mt-12 text-center sm:mt-16 sm:flex sm:items-start sm:justify-center sm:text-left">
          <img className="flex-shrink-0 object-cover mx-auto rounded-full w-28 h-28 sm:mx-0" src="https://cdn.rareblocks.xyz/collection/clarity/images/pricing/6/avatar-male.png" alt="" />
          <div className="mt-6 sm:mt-0 sm:ml-12">
            ...
            <p className="mt-5 text-base font-bold text-gray-900 font-pj">Marvin McKinney</p>
            <p className="text-sm font-normal text-gray-600 font-pj mt-0.5">Founder, StartBell</p>
          </div>
        </div>
      </div>
    </section>
