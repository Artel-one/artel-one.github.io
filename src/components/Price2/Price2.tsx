      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-pj text-3xl font-bold text-gray-900 sm:text-4xl xl:text-5xl">
            All features for one price. Try Rareblocks for free!
          </h2>
        </div>

        <div className="relative mx-auto mt-8 max-w-5xl md:mt-16">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gray-900">
            <div className="px-16 py-8 sm:px-8 lg:px-16 lg:py-14">
              <div className="md:flex md:items-center md:space-x-12 lg:space-x-24">
                <div className="grid grid-cols-1 gap-x-12 gap-y-3 sm:grid-cols-2 xl:gap-x-24">
                  <div>
                    <ul className="space-y-3 font-pj text-base font-medium text-white">
                ...
                <div className="block md:hidden lg:block">
                  <div className="hidden lg:block">
                    <svg
                      className="h-auto w-4 text-gray-600"
                      viewBox="0 0 16 123"
                      fill="none"
                      stroke="currentColor"
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="mt-10 block md:hidden">
                    <svg
                      className="h-4 w-auto text-gray-600"
                      viewBox="0 0 172 16"
                      fill="none"
                      stroke="currentColor"
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="mt-10 md:mt-0">
                  <div className="flex items-end">
                    <p className="font-pj text-5xl font-bold text-white">$19</p>
                    <p className="font-pj text-lg font-medium text-gray-400">
                      /month
                    </p>
                  </div>
                  ...
                  <a
                    ...
                    className="
                                    ...
                                    transition-all duration-200 hover:bg-opacity-90 focus:outline-none
                                    focus:ring-2
                                    focus:ring-white
                                    focus:ring-offset-2
                                "
        ...
        <div className="mx-auto mt-12 max-w-2xl text-center sm:mt-16 sm:flex sm:items-start sm:justify-center sm:text-left">
          <img
            ...
            alt=""
          />
          <div className="mt-6 sm:ml-12 sm:mt-0">
            <blockquote>
              <p className="font-pj text-lg font-normal leading-relaxed text-gray-900">
                “You made it so simple. My new site is so much faster and easier
                to work with than my old site. I just choose the page, make the
                change.”
              </p>
            </blockquote>
            <p className="mt-5 font-pj text-base font-bold text-gray-900">
              Marvin McKinney
            </p>
            <p className="mt-0.5 font-pj text-sm font-normal text-gray-600">
              Founder, StartBell
            </p>
          </div>
        </div>
