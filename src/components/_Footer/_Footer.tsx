      ...
      <div className="container mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6">
            ...
            <div>
              ...
              <ul className="font-medium text-white">
                ...
                <li className="mb-4">
                  <a href="/docs/cookie-policy.pdf" className="hover:underline">
                    Cookies Policy
                  </a>
                </li>
              </ul>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <a
            href="#"
            title=""
            className="mb-2 flex rounded outline-none focus:ring-1 focus:ring-gray-900 focus:ring-offset-2 sm:mb-0"
          >
